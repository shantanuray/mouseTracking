function [centroids, clusteridx] = reachStarWars(data)
...
control_after   = data(data(:,3)==3,1:2);
control_before  = data(data(:,3)==2,1:2);
ablated_after   = data(data(:,3)==1,1:2);
ablation_before = data(data(:,3)==0,1:2);
num_bins = 6;
num_colors = 0;

figure
plotDensityContour(ablated_after, num_bins, xrange, yrange, num_colors)
figure
plotDensityContour(ablation_before, num_bins, xrange, yrange, num_colors)

figure
plotDensityContour(control_after, num_bins, xrange, yrange, num_colors)
figure
plotDensityContour(control_before, num_bins, xrange, yrange, num_colors)

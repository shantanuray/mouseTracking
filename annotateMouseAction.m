...
%                       Defaults -  Left Video Angle - [320, 160; 600, 400];
...
if isempty(analyzeThis)
    analyzeMouseAnnotation(roiData, reachingEvents, videoFile, 'pellet', 'hand', 'foreground', true);
end
save(fullfile(matDir, [matPrefix,'.mat']), 'roiData', 'reachingEvents', 'isTremorCase', 'videoFile','refPixelLength');
return;
    ...
    function p = readInput(input)
        ...
        addParameter(p,'MarkingROILocation',defaultMarkingROILocation, @isinteger);
